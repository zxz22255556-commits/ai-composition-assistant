...
exports.main = async (event, context) => {
  console.log('[analyze] invoked, httpMethod:', event.httpMethod);
  ...
  try {
    ...
    console.log('[analyze] env - apiKey exists:', !!apiKey, 'model:', model);
    ...
    console.log('[analyze] AI responded in', elapsed, 'ms');
